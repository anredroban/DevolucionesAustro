...
class gsp_devolucionesAustro_layouts_sidebar_gsp extends GroovyPage {
...
printHtmlPart(27)
if(true && (Util.checkAccess(session.user.usuario, '/reportes/bitacoraDevoluciones'))) {
printHtmlPart(24)
if(true && (actionName == "bitacoraDevoluciones")) {
printHtmlPart(18)
}
printHtmlPart(25)
expressionOut.print(createLink(uri: '/reportes/bitacoraDevoluciones'))
printHtmlPart(28)
}
printHtmlPart(27)
...
public static final long LAST_MODIFIED = 1584651614088L
