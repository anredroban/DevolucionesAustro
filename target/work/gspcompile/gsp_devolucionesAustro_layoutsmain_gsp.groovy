...
class gsp_devolucionesAustro_layoutsmain_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('layoutTitle','g',8,['default':("Devoluciones")],-1)
})
...
public static final long LAST_MODIFIED = 1586398236364L
